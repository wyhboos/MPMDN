...
// std::vector<ompl::base::ScopedState<>>* ompl::geometric::MPN::bidirectional_plan(ompl::base::ScopedState<> start, ompl::base::ScopedState<> goal)
// {
//     int iter_cnt = 0;
...
// at::Tensor ompl::geometric::MPN::get_state_tensor_from_state(std::vector<ompl::base::ScopedState<>>* state)
// {
...
// ompl::base::ScopedState<>* ompl::geometric::MPN::get_state_ompl_from_tensor(at::Tensor state_t)
//  {
//     base::StateSpacePtr space = si_->getStateSpace();
...
// void ompl::geometric::MPN::load_Enet_Pnet(string Enet_file, string Pnet_file)
{
